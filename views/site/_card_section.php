<div class="card-section">
    <div class="container">
        <div class="d-flex justify-content-center flex-column">
            <h2 class="demo-card-title-section">What are you looking for?</h2>
            <p class="col-10 col-lg-5 demo-card-para">We offer a variety of room types to choose from, so you can find the perfect one for your needs.</p>
        </div>
        <div class="row gy-4">
            <div class="col-lg-4">
                <div class="card shadow-card">
                    <div class="demo-card">
                        ...
                        <div class="d-flex flex-row room-price box-price">
        ...
        <div class="mt-5"></div>
        <a href="<?= Yii::getAlias('@web/home/accommodation') ?>" class="btn btn-outline-success btn-see-more">see more</a>
    </div>
</div>