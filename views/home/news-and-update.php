...
<section class="section-news-and-update">
    ...
    <div class="container">
        <div class="d-flex flex-column align-items-center justify-content-center">
            <h2 class="news-and-update-title">NEWS AND UPDATE</h2>
        </div>
    </div>
</section>
<section class="section-News">
    <div class="container">
        <div class="d-flex">
            <h2 class="demo-news-title me-2">Siem Reap</h2>
...
<section class="section-Update">
    <div class="container">
        <div class="d-flex">
            <h2 class="demo-news-title me-2">Discover</h2>
            <h2 class="news-title">Update</h2>
        </div>
        <div class="line-news"></div>
        <div class="row gy-4 gx-3 mt-4">
            <?php foreach ($CardNewsandUpdate as $value) {
...
<section class="section-partner-news-and-update">
